...
import {TripComment, TripCommentRelations, Trip, User} from '../models';
...
> {
  ...
  public readonly trip: BelongsToAccessor<Trip, typeof TripComment.prototype._id>;

  public readonly publisher: BelongsToAccessor<User, typeof TripComment.prototype._id>;

  public readonly receiver: BelongsToAccessor<User, typeof TripComment.prototype._id>;

  constructor(
    @inject('datasources.mongodb') dataSource: MongodbDataSource, @repository.getter('TripRepository') protected tripRepositoryGetter: Getter<TripRepository>, @repository.getter('UserRepository') protected userRepositoryGetter: Getter<UserRepository>,
  ) {
